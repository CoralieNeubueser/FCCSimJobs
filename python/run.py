...
if __name__=="__main__":
    ...
    parser.add_argument('--version', type=str, help='Version to use', choices = ['v01', 'v02_pre', 'v02', 'v03', 'v03_hcalOnly', 'v03_hcalOnly_fullSteel', 'v03_hcalOnly_fullLead', 'v03_hcalOnly_newHCalGeo'])
